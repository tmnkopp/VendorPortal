...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VendorPortal.Models.Vendor", b =>
                {
            ...
            modelBuilder.Entity("VendorPortal.Models.VendorCategory", b =>
                {
            ...
            modelBuilder.Entity("VendorPortal.Models.VendorType", b =>
                {
                    b.Property<int>("VendorTypeID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VendorPortal.Models.Vendor", b =>
                {
                    b.HasOne("VendorPortal.Models.VendorType", "VendorType")
                        .WithMany("Vendors")
            ...
            modelBuilder.Entity("VendorPortal.Models.VendorCategoryMap", b =>
                {
                    b.HasOne("VendorPortal.Models.VendorCategory", "VendorCategory")
                        .WithMany("VendorCategoryMaps")
                        .HasForeignKey("VendorCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("VendorPortal.Models.Vendor", "Vendor")
                        .WithMany("VendorCategoryMaps")
